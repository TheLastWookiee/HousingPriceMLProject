...
# Load the dataset
HouseDF = pd.read_csv('C:/Users/Caiden Henn/Downloads/archive (1)/1553768847-housing.csv')
...
# Gradient Boosting
DT = RandomForestRegressor(criterion='absolute_error', max_depth= 9, max_features= 'sqrt', max_leaf_nodes= 6, n_estimators= 25)
